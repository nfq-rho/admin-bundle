...
/**
 * Class AdminManagersCompilerPass
 * @package Nfq\AdminBundle\DependencyInjection\Compiler
 */
class AdminManagersCompilerPass implements CompilerPassInterface
{
    /**
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds('nfq_admin.manager') as $id => $attributes) {
            ...
            $def->addMethodCall('setActions', [new Reference('nfq_admin.generic_actions_service')]);
        }
    }
}
